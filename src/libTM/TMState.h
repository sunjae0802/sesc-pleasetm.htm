...
enum TMAbortType_e { TM_ATYPE_NONTM = 255, TM_ATYPE_DEFAULT = 0, TM_ATYPE_USER = 1, TM_ATYPE_CAPACITY = 2, TM_ATYPE_SYSCALL = 3, TM_ATYPE_PREEMPTIVE = 4, TM_ATYPE_NACKOVERFLOW = 5 };
