...
private:
    ...
    LClock     myLClock;
    ClockValue getCheckClock(void) const {
        return myCheckClock;
    }
    ...
    public:
        ...
        bool raceEmpty(void) const {
            return race.empty();
        }
        bool chkaEmpty(void) const {
            return chka.empty();
        }
        bool lamaEmpty(void) const {
            return lama.empty();
        }
        bool runaEmpty(void) const {
            return runa.empty();
        }
        bool anomEmpty(void) const {
            return anom.empty();
        }
    ...
    struct State {
        ...
        State &operator=(AtmEnum newAtm) {
            atm=newAtm;
            return *this;
        }
        bool operator==(AtmEnum cmpAtm) const {
            return atm==cmpAtm;
        }
        bool operator!=(AtmEnum cmpAtm) const {
            return atm!=cmpAtm;
        }
        State &operator=(AcqEnum newAcq) {
            acq=newAcq;
            return *this;
        }
        bool operator==(AcqEnum cmpAcq) const {
            return acq==cmpAcq;
        }
        bool operator!=(AcqEnum cmpAcq) const {
            return acq!=cmpAcq;
        }
        State &operator=(RelEnum newRel) {
            rel=newRel;
            return *this;
        }
        bool operator==(RelEnum cmpRel) const {
            return rel==cmpRel;
        }
        bool operator!=(RelEnum cmpRel) const {
            return rel!=cmpRel;
        ...
        bool operator!=(SuccEnum cmpSucc) const {
            return !operator==(cmpSucc);
        }
        State &operator=(SpecEnum newSpec) {
            spec=newSpec;
            return *this;
        }
        State &operator=(ExecEnum newExec) {
            exec=newExec;
            return *this;
        }
        State &operator=(IterEnum newIter) {
            iter=newIter;
            return *this;
        }
        State &operator=(MergEnum newMerg) {
            merg=newMerg;
            return *this;
        }
        State &operator=(WaitEnum newWait) {
            wait=newWait;
            return *this;
        }
        bool operator==(SpecEnum cmpSpec) const {
            return spec==cmpSpec;
        }
        bool operator!=(SpecEnum cmpSpec) const {
            return spec!=cmpSpec;
        ...
        bool operator==(ExecEnum cmpExec) const {
            return exec==cmpExec;
        }
        bool operator!=(ExecEnum cmpExec) const {
            return exec!=cmpExec;
        }
        bool operator==(IterEnum cmpIter) const {
            return iter==cmpIter;
        }
        bool operator!=(IterEnum cmpIter) const {
            return iter!=cmpIter;
        ...
        bool operator==(MergEnum cmpMerg) const {
            return merg==cmpMerg;
        }
        bool operator!=(MergEnum cmpMerg) const {
            return merg!=cmpMerg;
        ...
        bool operator==(WaitEnum cmpWait) const {
            return wait==cmpWait;
        }
        bool operator!=(WaitEnum cmpWait) const {
            return wait!=cmpWait;
        ...
        bool operator!=(HoldEnum cmpHold) {
            return !operator==(cmpHold);
        }
    };
