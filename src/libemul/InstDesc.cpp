...
struct ident : public function1<_V,_T,_T> {
    static inline _T eval(const _T &arg1, int arg2=0, int arg3=0) {
        return arg1;
    }
};
template <class _V, class _T>
...
private:
    ...
    static inline TRes eval(const TArg1 &arg1=0, const TArg2 &arg2=0, const TArg3 &arg3=0) {
        return -_F::eval(arg1,arg2,arg3);
    }
};
template <class _V, class _T>
...
struct shl : public function2<_V,_T,_T,_S> {
    static inline _T eval(const _T &arg1, const _S &arg2, int arg3=0) {
...
struct fround : public function1<_V,_Td,_Ts> {
    static inline _Td eval(const _Ts& arg1, int arg2=0, int arg3=0) {
        return _Td(round(arg1));
    }
};
template<class _V, class _Ts, class _Td>
struct ftrunc : public function1<_V,_Td,_Ts> {
    static inline _Td eval(const _Ts& arg1, int arg2=0, int arg3=0) {
        return _Td(trunc(arg1));
    }
};
template<class _V, class _Ts, class _Td>
struct fceil : public function1<_V,_Td,_Ts> {
    static inline _Td eval(const _Ts& arg1, int arg2=0, int arg3=0) {
        return _Td(ceil(arg1));
    }
};
template<class _V, class _Ts, class _Td>
struct ffloor : public function1<_V,_Td,_Ts> {
    static inline _Td eval(const _Ts& arg1, int arg2=0, int arg3=0) {
        return _Td(floor(arg1));
    }
};
...
struct fcmp : public function2<_V,bool,_Tp,_Tp> {
    static inline bool eval(const _Tp& __x, const _Tp& __y, int arg3=0) {
        return ((UseLt&&(__x<__y))||(UseEq&&(__x==__y))||(UseUn&&std::isunordered(__x,__y)));
    }
};

template <class _V, class _R=bool>
struct tt : public function0<_V,_R> {
    static inline _R eval(int arg1=0, int arg2=0, int arg3=0) {
        return true;
    }
};
template <class _V, class _T, class _R=bool>
struct eq : public function2<_V,_R,_T,_T> {
    static inline _R eval(const _T &arg1, const _T &arg2, int arg3=0) {
        return _R(arg1==arg2);
    }
};
template <class _V, class _T, class _R=bool>
...
struct eqz : public function1<_V,_R,_T> {
    static inline _R eval(const _T &arg1, int arg2=0, int arg3=0) {
        return _R(arg1==_T(0));
    }
};
template <class _V, class _T, class _R=bool>
...
public:
    ...
    static RegName decodeArg(InstArgInfo arg, RawInst inst) {
        ...
        case ArgNo:
            return RegNone;
        case ArgRd:
            return static_cast<RegName>(((inst>>11)&0x1F)+GprNameLb);
        case ArgRt:
            return static_cast<RegName>(((inst>>16)&0x1F)+GprNameLb);
        case ArgRs:
            return static_cast<RegName>(((inst>>21)&0x1F)+GprNameLb);
        case ArgTmp:
            return static_cast<RegName>(RegTmp);
        case ArgBTmp:
            return static_cast<RegName>(RegBTmp);
        case ArgFd:
            return static_cast<RegName>(((inst>> 6)&0x1F)+FprNameLb);
        case ArgFt:
            return static_cast<RegName>(((inst>>16)&0x1F)+FprNameLb);
        case ArgFs:
            return static_cast<RegName>(((inst>>11)&0x1F)+FprNameLb);
        case ArgFr:
            return static_cast<RegName>(((inst>>21)&0x1F)+FprNameLb);
        case ArgFCs:
            return static_cast<RegName>(((inst>>11)&0x1F)+FcrNameLb);
        case ArgHs:
            return static_cast<RegName>(((inst>>11)&0x1F)+HwrNameLb);
        case ArgFTmp:
            return static_cast<RegName>(RegFTmp);
        case ArgFCSR:
            return static_cast<RegName>(RegFCSR);
        case ArgRM:
            return static_cast<RegName>(FpRMode);
        case ArgFccc:
            return static_cast<RegName>(FccNameLb+((inst>>8)&0x7));
        case ArgFbcc:
            return static_cast<RegName>(FccNameLb+((inst>>18)&0x7));
        case ArgRa:
            return static_cast<RegName>(RegRA);
        case ArgHi:
            return static_cast<RegName>(RegHi);
        case ArgLo:
            return static_cast<RegName>(RegLo);
        case ArgCond:
            return static_cast<RegName>(RegCond);
        default:
    ...
    static InstImm decodeImm(InstImmInfo imm, RawInst inst, VAddr addr) {
        ...
        case ImmNo:
            return uint32_t(0);
        case ImmJpTg:
            return static_cast<Taddr_t>(((addr+sizeof(inst))&(~0x0fffffff))|((inst&0x03ffffff)*sizeof(inst)));
        case ImmBrOf:
            return static_cast<Taddr_t>((addr+sizeof(inst))+((static_cast<int16_t>(inst&0xffff))*sizeof(inst)));
        case ImmSExt:
            return static_cast<int16_t>(inst&0xffff);
        case ImmZExt:
            return static_cast<uint16_t>(inst&0xffff);
        case ImmLui:
            return static_cast<int32_t>((inst<<16)&0xffff0000);
        case ImmSh:
            return static_cast<uint8_t>((inst>>6)&0x1F);
        case ImmSh32:
            return static_cast<uint8_t>(32+((inst>>6)&0x1F));
        case ImmExCd:
            return static_cast<uint32_t>((inst>>6)&0xFFFFF);
        case ImmTrCd:
            return static_cast<uint16_t>((inst>>6)&0x3FF);
        default:
    ...
    static inline T getSrc(InstDesc *inst, ThreadContext *context) {
        switch(V) {
        case ValR1:
            return getReg<T,S1Typ>(context,inst->regSrc1);
        case ValR2:
            return getReg<T,S2Typ>(context,inst->regSrc2);
        case ValI1:
            return T(inst->imm);
        case ValNo:
            return 0;
        default:
            fail("Unsupported V in getSrc\n");
        }
    }
    ...
    static inline void setDst(InstDesc *inst, ThreadContext *context, const T &val) {
        switch(V) {
        case ValD1:
            return setReg<T,DTyp>(context,inst->regDst,val);
        case ValNo:
            return ;
        default:
            fail("Unsupported V in setDst\n");
        }
    }
    typedef enum {
...
//                return inst;
    ...
    class emulJJ {
        ...
        static InstDesc *emul(InstDesc *inst, ThreadContext *context) {
            ...
            uint16_t type = inst->regDst;
            //printf(" type: %u %d\n",type, addr);
            /*
             *  pref hint field
             *
             *  11: sim start (roi start)
             *  12: sim end   (roi end)
             */
            if(type == 11) {
                if(ThreadContext::ff == true) {
                    printf("[SESC] Simulation Start\n");
                    fflush(stdout);
                    ThreadContext::ff = false;
                }
            } else if(type == 12) {
                printf("[SESC] Simulation End\n");
                printf("[SESC] Timestamp %lld\n", globalClock);
                fflush(stdout);
...
//     ops[OpKey(0xFC000000,0xF8000000)]<<OpData("sdc2", CtlNorm , MemOpSt8>());
    //ops[OpKey(0xFC000000,0xCC000000)]<<OpData("pref", CtlNorm , TypNop   , ArgNo  , ArgNo  , ArgNo  , ImmNo  , emulJJ<AddrRegImm>());
    ops[OpKey(0xFC000000,0xCC000000)]<<OpData("pref", CtlNorm , MemOpLd4, ArgRt  , ArgRs  , ArgNo  , ImmSExt, emulJJ<AddrRegImm>());
    ops[OpKey(0xFC00003F,0x4C00000F)]<<OpData( "prefx",CtlNorm , TypNop   , ArgNo  , ArgNo  , ArgNo  , ImmNo  , emulNop);
...
void decodeTrace(ThreadContext *context, VAddr addr, size_t len) {
    ...
    case ExecModeMips32:
        return decodeTrace<ExecModeMips32>(context,addr,len);
#endif
#if (defined SUPPORT_MIPSEL32)
    case ExecModeMipsel32:
        return decodeTrace<ExecModeMipsel32>(context,addr,len);
#endif
#if (defined SUPPORT_MIPS64)
    case ExecModeMips64:
        return decodeTrace<ExecModeMips64>(context,addr,len);
#endif
#if (defined SUPPORT_MIPSEL64)
    case ExecModeMipsel64:
        return decodeTrace<ExecModeMipsel64>(context,addr,len);
#endif
    default:
